...
//   const confirmUpdate = async () => {
//     try {
//       // Dispatch the updateAdmin action with email and newPassword
//       const response = await dispatch(updateAdmin({ email, password: newPassword })).unwrap();
...
//               <button onClick={() => setShowConfirmation(false)} className="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 mt-4">Cancel</button>
//             </div>
//           </Popup>
//         )}
//       </div>
